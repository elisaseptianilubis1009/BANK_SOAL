        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">          
                <ul class="nav navbar-nav">
                    ...
                    ?>
                    <a href="index.php"> <i class="menu-icon fa fa-windows"></i>ADMIN </a>
                    <?php 
                    }
                    ?>
                    <?php 
                    ...
                    ?>
                    <a href="index.php"> <i class="menu-icon fa ffa-windows"></i>CONSTRIBUTOR </a>
                    <?php 
                    }
                    ?>
                    ...
                    ?>
                    <a href="index.php"> <i class="menu-icon fa fa-windows"></i>USER </a>
                    <?php 
                    }
                    ?>
                    </li>
                    ...
                    <li class="menu-item-has-children dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-laptop"></i> GUDANG SOAL</a>
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-book"></i><a href="?page=tampilsoal">Tampilkan Soal</a></li>
                        </ul>
                    </li>
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                             <?php 
                                if (@$_SESSION['hak'] == "admin" ) {                            
                             ?>
                            <li><i class="fa fa-table"></i><a href="?page=TampilUser">Data User</a></li>
                            <li><i class="fa fa-table"></i><a href="?page=Tampil_Kelas">Data Kelas</a></li>
                            <li><i class="fa fa-table"></i><a href="?page=Tampil_Mapel"> Mata pelajaran</a></li>
                            <li><i class="fa fa-table"></i><a href="?page=Tampil_Ambil_Soal">Pengambilan Soal</a></li>
                            <li><i class="fa fa-table"></i><a href="?page=Tampil_Status">Data Status</a></li>
                            <li><i class="fa fa-table"></i><a href="?page=Tampil_Tema">Data Tema</a></li>
                            <li><i class="fa fa-table"></i><a href="?page=Tampil_Subtema">Data Subtema</a></li>
                            <?php 
                         }
                             ?>
                        </ul>
